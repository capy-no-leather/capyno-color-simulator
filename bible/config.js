/* 【バイブル】カラーを選べるカピバラのシステム手帳 用の設定
   新しい商品のシミュレーターを作るときは、このファイルをコピーして
   色・商品ページURL・文言だけを書き換える。
   （アートワークSVGとその<style>の対応は index.html 側）
*/
const SIMULATOR_CONFIG = {
  productPageUrl: "https://capyno.official.ec/items/127831158",
  ...
  targets: [
    {
      ...
      colors: [
        ...
        { code: "2", name: "イエロー",       hex: "#F8BA33", border: "#D98C18", linked: { "--main-suede-color": "#EFA13A" } },
        ...
        { code: "7", name: "ブラウン",       hex: "#DFA272", border: "#B97A4E", linked: { "--main-suede-color": "#E59456" } },
